...
export const metadata: Metadata = {
  ...
  description: 'Компания Озон Градус - Политика конфиденциальности',
  ...
  openGraph: {
    title: 'Политика конфиденциальности',
    description: 'Компания Озон Градус - Политика конфиденциальности',
    url: 'https://ozon-gradus.ru/agreements/privacy',
...
ООО Озон Градус (далее – Оператор). <br />
...
Оператор может получить о посетителях веб-сайта https://www.ozon-gradus.ru/.<br />
<br />
...
интернет по сетевому адресу https://www.ozon-gradus.ru/;<br />
...
https://www.ozon-gradus.ru/;<br />

2.9. Пользователь – любой посетитель веб-сайта https://www.ozon-gradus.ru/;<br />
...
средствах массовой информации, размещение в информационнотелекоммуникационных сетях или предоставление доступа к персональным
...
3.6. Вышеперечисленные данные далее по тексту Политики объединены общим
понятием Персональные данные.<br /><br />
...
relux.company@mail.ru с пометкой «Отказ от уведомлений о новых продуктах и
...
Пользователей на сайте, улучшения качества сайта и его содержания.<br /><br />
...
специальные формы, расположенные на сайте https://www.ozon-gradus.ru/.
...
<br /><br />
<b>6. Порядок сбора, хранения, передачи и других видов обработки персональных данных
...
законодательства в области защиты персональных данных.</b>
<br />
...
уведомление на адрес электронной почты Оператора relux.company@mail.ru с
...
электронной почты на электронный адрес Оператора relux.company@mail.ru с
...
Оператору с помощью электронной почты relux.company@mail.ru.<br />
...
Интернет по адресу https://www.ozon-gradus.ru/agreements/privacy.
            </div>
    )
  }
