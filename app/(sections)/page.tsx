       ...
       <section className='index_bg'>
            ...
            <div className='container flex align-center flex-nowrap justify-space'>
                  <div className='text'>
                      ...
                      <span>Приглашаем вас присоединиться к команде профессионалов в &quot;Озон Градус&quot;  <br />- ведущую компанию в своей отрасли. Мы предоставляем разнообразные возможности для карьерного роста, профессионального развития и дружественную рабочую среду.</span>
                  </div>
