    ...
    <div className={`content ${pathname === '/' ? 'index_content' : ''}`}>
       <section className='index_bg'>
            ...
            <div className='container flex align-center flex-nowrap justify-space'>
                  <div className='text'>
                      <h1>В компанию ozon градус <br /> требуются операторы склада</h1>
                      <span>Приглашаем вас присоединиться к команде профессионалов ООО &quot;Озон Градус&quot;  <br />- ведущую компанию в своей отрасли. Мы предоставляем разнообразные возможности для карьерного роста, профессионального развития и дружественную рабочую среду.</span>
                  </div>
            ...
            <div className='flex mr_bt_down_40'>
              <div className='w-7'>
                <div className='block'>
                    ...
                    <span>&quot;Озон Градус&quot; постоянно в поиске талантливых и целеустремленных людей. Мы предлагаем широкий спектр вакансий в различных областях. Наша компания ценит индивидуальные способности каждого сотрудника и создает комфортные условия для обучения и профессионального роста.</span>
                    
                </div>
                <div className='block'>
                    <h1>Профессиональное сопровождение</h1>
                    <span>Команда &quot;Озон Градус&quot; готова предоставить вам поддержку во время всех этапов трудоустройства и в работе. Мы ценим каждого сотрудника и делаем все возможное, чтобы создать благоприятную и эффективную рабочую среду.</span>
                    
                </div>
                <div className='block'>
                    <h1>Присоединяйтесь к нашей команде уже сегодня!</h1>
                    <span>Если вы готовы присоединиться к лидерам в своей сфере и построить успешную карьеру в &quot;Озон Градус&quot;, ознакомьтесь с нашими актуальными вакансиями и отправьте нам свое резюме. Мы будем рады приветствовать вас в нашей дружной и профессиональной команде.</span>
              ...
              <div className='block'>
                  ...
                  <span>
                      ...
                      - Комплектация заказов с использованием ручного терминала<br />
                      - Выполнение заданий на ручном терминале сбора данных
                  </span>
                </div>
                <div className='block'>
                  <h1>Мы пpедлагаем:</h1>
                  <span>
                      ...
                      - Грaфик paботы: 2/2, 5/2, 6/1
                      - Дневные и ночные смены <br />
