  ...
  return (
            <div className='flex'>
              <div className='w-6'>
                <div className='block'>
                    <h1>Наш адрес:</h1>
                    <p>Респ. Татарстан, р-н Зеленодольский, с. Новая Тура, 19</p>
                    <Map />
                  </div>
              </div>
              <div className='w-6'>
                  <div className='block'>
                    ...
                    <p>Для пешехода, если едет со стороны Казани: доезжает на автобусе 117 либо 104 до остановки Рынок Новая Тура. Двигается
                    ...
                    С автовокзала Мирный, автобус No 104, до остановки Рынок Новая тура.</p>
                  </div>
                  <div className='block'>
                    <h1>Собственное авто</h1>
                    <p>Въезд со стороны трассы М-7. Поворот на Объект 784. Кандидат доезжает до пункта КПП . Звонит в Отдел персонала и
                    сообщает номер автомобиля. На территории парковки стоит 2х этажное здание, на нем написано БЮРО ПРОПУСКОВ.
                    Отдел персонала находится на 2ом этаже, кабинет No6.</p>
                  </div>
              </div>
            </div>
  )
