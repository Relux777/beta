...
export const metadata: Metadata = {
  title: 'Работа на складе OZON - Вакансии операторов склада в компании ООО "Озон Градус" город Казань',
  ...
  return (
    <html lang="ru">
      <head>
        ...
        <meta property="og:title" content="Работа на складе OZON - Вакансии операторов склада в компании Озон Градус город Казань" />
